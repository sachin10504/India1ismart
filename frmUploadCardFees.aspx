<%@ Page Title="" Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="frmUploadCardFees.aspx.cs" Inherits="Reports.frmUploadCardFees" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="divContentWrapper">
        ...
        <div id="divUploadFile">
            <form id="frmUploadCardFees" method="post" runat="server" action="/UPCF">
                <table width="100%">
                    <tr>
                        <td>
                            <asp:FileUpload ID="FileUploadCardFee" runat="server"></asp:FileUpload>
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <button class="ClUpCardFees" id="BtnuploadCF" type="button">Upload File</button>
                            &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <%--<button class="ClUpCardFees" id="BtnViewBinScheme" type="button">View BIN and Scheme Configuration</button>--%>
                            <asp:Button ID="BtnViewBinScheme" runat="server" Text="View BIN and Scheme Configuration" OnClick="BtnViewBinScheme_Click" CssClass="ButtonClass" Style="height: 25px; width: 250px;" />
                        </td>
                    </tr>
                        ...
                        <td>
                            ...
                            <div id="DivMain" align="center" runat="server">
                                ...
                                <div id="DivGrid" align="center" runat="server" style="height: auto; width: 820px;">
                                    ...
                                    <%--                            <asp:gridview ID="GridCardFees" runat="server" AutoGenerateColumns="False" CellPadding="4" PageSize="10"
            ForeColor="#333333" GridLines="None" Width="700px" AllowPaging="True" CssClass="Grid"
