<%@ Page Title="" Language="C#" MasterPageFile="~/Reports.Master" AutoEventWireup="true" CodeBehind="frmUploadthreshold.aspx.cs" Inherits="Reports.frmUploadthreshold" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="divContentWrapper">
        <div class="ui-widget-header">Upload Threshold Details</div>
        <div id="divUploadFile">
            <form id="frmUploadthreshold" method="post" runat="server" action="/UPTH">
                <table width="100%">
                    <tr>
                        <td>
                            <asp:FileUpload ID="FileUploadThreshold" runat="server"></asp:FileUpload>
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <button class="ClUpThreshold" id="BtnuploadUT" type="button">Upload File</button>
                            &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            
                            <%--<asp:Button ID="BtnViewThreshold" runat="server" Text="View Threshold Configuration" OnClick="BtnViewThreshold_Click" CssClass="ButtonClass" Style="height: 25px; width: 250px;" />--%>
                        </td>
                    </tr>
                                ...
                                <div id="DivGrid" align="center" runat="server" style="height: auto; width: 820px;">
                                    ...
                                    <asp:GridView ID="GridCardFees" runat="server" AutoGenerateColumns="false" Width="800px"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="CumulativeBalance" HeaderText="CumulativeBalance" />
                                            <asp:BoundField DataField="DispenseAmount" HeaderText="DispenseAmount" />
